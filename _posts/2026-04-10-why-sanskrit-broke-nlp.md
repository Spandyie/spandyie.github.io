---
layout: post
title: "Why Does Sanskrit Push Computational NLP to Its Limits? "
date: 2026-04-10
tags: [sanskrit, nlp, morphology, cltk, linguistics, technical]
description: "A walkthrough of sandhi, compound decomposition, and the tools researchers built to handle it."
---
...
There are broadly 4 categories of tokenization:
...
So the process basically involves converting texts into tokens and maintaining an inventory of them. The superset of all unique tokens is what makes up the vocabulary. Feel free to use [OpenAI's tokenizer playground](https://platform.openai.com/tokenizer) to see tokenization in action.
